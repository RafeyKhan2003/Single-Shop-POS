...
contextBridge.exposeInMainWorld('posApi', {
  ...
  autoSavePurchaseDraft: (data) => Purchase.autoSavePurchaseDraft(data),
  getPurchaseDraft: () => Purchase.getPurchaseDraft(),
  ...
  autoSaveWorkshopDraft: (data) => Workshop.autoSaveWorkshopDraft(data),
  getWorkshopDraft: () => Workshop.getWorkshopDraft(),
